...
foreach hemi (lh rh)
  foreach surf ($surfaces)
    tksurfer -$subject ${hemi} ${surf} -tcl ~/bin/freesurfer_ucsf_highN_viewlabels.tcl
    #tksurfer -$subject ${hemi} ${surf} -tcl ~/bin/freesurfer_ucsf_highN_viewlabels_surface.tcl
    #tksurfer -$subject ${hemi} ${surf} -tcl ~/bin/freesurfer_ucsf_highN_viewlabels_volume.tcl
  end
end
