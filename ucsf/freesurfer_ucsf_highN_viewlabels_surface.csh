...
foreach hemi (lh rh)
  foreach surf ($surfaces)
    tksurfer -$subject ${hemi} ${surf} \
        -tcl ~/bin/freesurfer_ucsf_highN_viewlabels_surface.tcl
    
    # The volume option to mri_label2label did not
    # produce output with vertex numbers.
        
    #tksurfer -$subject ${hemi} ${surf} \
    #    -tcl ~/bin/freesurfer_ucsf_highN_viewlabels_volume.tcl
  end
end
